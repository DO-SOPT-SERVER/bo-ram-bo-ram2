...
import SOPT.server.seminar3.dto.request.member.MemberCreateRequest;
import SOPT.server.seminar3.dto.request.member.MemberGetResponse;
import SOPT.server.seminar3.dto.request.member.MemberProfileUpdateRequest;
import SOPT.server.seminar3.service.MemberService;
...
@RestController
@RequestMapping("/seminar2/api/member")
